...
if($_REQUEST['action'] == 'updatecache'){
	opcache_reset();
...
<body>
    <div id="container">
		...
		<input type="button" value="update cache" onclick="updateCache()"/>
		<div id="update-result" style="margin-bottom:50px;"></div>
        <div class="tabs">
    ...
    <script>
		...
		function updateCache(){
			$.get("?action=updatecache&t=" + Math.random(),function(res){
