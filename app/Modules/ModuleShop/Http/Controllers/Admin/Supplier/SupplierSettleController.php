...
use App\Modules\ModuleShop\Libs\Supplier\SupplierSettleAdmin;
use Illuminate\Http\Request;
use App\Modules\ModuleShop\Http\Controllers\Admin\BaseAdminController;
use Illuminate\Support\Collection;
use YZ\Core\Common\Export;

class SupplierSettleController extends BaseAdminController
{
    public function getList(Request $request)
    {
        try {
            $param = $request->all();
            $settle = new SupplierSettleAdmin();
    ...
    public function export(Request $request)
    {
        try {
            ...
            // 导出
            $exportObj = new Export(new Collection($exportData), 'GongYingShangJieSuan-' . date("YmdHis") . '.xlsx', $exportHeadings);
