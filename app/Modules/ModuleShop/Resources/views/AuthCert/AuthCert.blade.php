            ...
            <div class="module-item {{$module['module_type']}}" style="{{getModuleStyle($module)}}">
                ...
                @elseif ($module['module_type'] == 'ModuleNickName')
                    <div class="text-container" style="{{getNickNameStyle($module,$fontscale)}}">
                        {{$memberInfo['nickname'] ? $memberInfo['nickname'] : '会员昵称'}}
                    </div>
                @elseif ($module['module_type'] == 'ModuleText')
                    <div class="text-container" style="{{getTextStyle($module,$fontscale)}}">
                        {{$module['text']}}
                    </div>
                @elseif ($module['module_type'] == 'ModuleLevel')
                    <div class="text-container" style="{{getCommonTextStyle($module,$fontscale)}}">
                        {{$module['text']}}
                    </div>
                @elseif ($module['module_type'] == 'ModuleAuthDate')
                    <div class="text-container" style="{{getCommonTextStyle($module,$fontscale)}}">
                        {{$module['text']}}
                    </div>
                @elseif ($module['module_type'] == 'ModuleAuthCode')
                    <div class="text-container" style="{{getCommonTextStyle($module,$fontscale)}}">
                        {{$module['text']}}
                    </div>
                @elseif ($module['module_type'] == 'ModuleAuthTerm')
                    <div class="text-container" style="{{getCommonTextStyle($module,$fontscale)}}">
                        {{$module['text']}}
                    </div>
...
@php
    ...
    function getCommonTextStyle($module,$fontscale){
        $css = [
            'color' => $module['color'],
            'text-align' => $module['textAlign'] ? $module['textAlign'] : 'left',
            'font-weight' => $module['bold'] ? 'bold':'normal',
