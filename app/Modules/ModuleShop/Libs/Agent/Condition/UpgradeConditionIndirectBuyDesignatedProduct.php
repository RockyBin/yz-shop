 ...
 * 间推指定商品升级条件
 */
class UpgradeConditionIndirectBuyDesignatedProduct extends abstractCondition
{
    protected $value = '';
    ...
    public function canUpgrade($memberId, $params = [])
    {
        ...
        if ($this->productid) {
            ...
            //level>1 是order_members_history购买者与该表member_id的层级关系，也就是level>1的时候member_id与购买者就是间推推荐关系
//            $sql = 'select
//                    sum(
//                    ' . $select . '
//                    ) as count,
