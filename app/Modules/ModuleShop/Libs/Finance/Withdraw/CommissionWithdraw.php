 ...
 */
class CommissionWithdraw extends AbstractWithdraw
{
    ...
    public function __construct()
    {
        ...
        if (!$this->_model) {
            ...
            $this->_model->commission_type = '{"balance":1,"wxpay":0,"alipay":0,"wx_qrcode":0,"alipay_qrcode":0,"alipay_account":0,"bank_account":0}';
    ...
    public function getAvailableBalance($financeType, $memberId){
        return FinanceHelper::getMemberCommissionBalance($memberId,$financeType);
    }
    ...
    {
        $info = json_decode($this->_model->commission_type, true);
        return $info;
    }
}