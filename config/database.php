...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Default DbLock Connection Name
    |--------------------------------------------------------------------------
    |
    | Here you may specify which of the database connections below you wish
    | to use as your default connection for all database work. Of course
    | you may use many connections at once using the DbLock library.
    |
    */
...
//        ],
        // 防伪码数据表
        'system_security_code_sqlite' => [
            'driver' => 'sqlite',
            'database' => database_path('system_security_code.sqlite'),
            'prefix' => '',
        ],
